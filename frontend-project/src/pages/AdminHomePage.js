...
const AdminHomePage = () => {
  ...
  const mockOrderData = [
    ...
    },
    {
      ...
      status: 'cancelled',
      details: '1 x Pasta',
      restaurant: 'Gourmet Place',
      deliveryPerson: 'Chris',
    },
    {
      id: '5',
      user: 'David Lee',
      ...
      deliveryPerson: 'Jordan',
    },
    {
      id: '6',
      user: 'Emily Brown',
      status: 'completed',
      details: '4 x Sushi Rolls',
      restaurant: 'Test Restaurant A',
      deliveryPerson: 'Alex',
    },
    {
      ...
      user: 'Chris Williams',
      status: 'active',
      details: '1 x Cheeseburger, 1 x Fries',
      restaurant: 'Sample Eatery',
      deliveryPerson: 'Taylor',
    },
    {
    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 p-10">
      <div className="w-full max-w-6xl space-y-10">
        ...
        <section className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-blue-500">
          ...
          <div className="mt-8">
            <DeliveryPersonLocationMonitor
              locations={mockDeliveryPersonLocations}
            />
          </div>
        </section>
        ...
        <section className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-yellow-500">
          ...
          <div className="space-y-6">
            ...
            <RestaurantPerformanceAnalysis
              performance={mockRestaurantPerformance}
            />
          </div>
        </section>
      </div>
